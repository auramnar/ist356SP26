...
def run(playwright: Playwright) -> None:
    browser = playwright.chromium.launch(headless=False, timeout=60000) # Launch the Chromium browser (headless=False shows the browser window)
